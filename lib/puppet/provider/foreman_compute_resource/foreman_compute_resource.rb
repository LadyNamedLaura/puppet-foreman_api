    ...
    def self.endpoint
      @endpoint ||= Endpoint.new(
        ...
        attributes: [
          ...
          AttrDefinition.new(:project_domain_name, 'project_domain_name', "compute_resource[project_domain_name]"),
          ...
          AttrDefinition.new(:keyboard_layout, 'keyboard_layout', "compute_resource[keyboard_layout]"),
          AttrDefinition.new(:caching_enabled, 'caching_enabled', "compute_resource[caching_enabled]"),
          AttrDefinition.new(:project, 'project', "compute_resource[project]"),
          AttrDefinition.new(:email, 'email', "compute_resource[email]"),
          AttrDefinition.new(:key_path, 'key_path', "compute_resource[key_path]"),
          AttrDefinition.new(:zone, 'zone', "compute_resource[zone]"),
